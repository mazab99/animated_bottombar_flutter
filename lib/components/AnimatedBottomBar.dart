...
class AnimatedBottomBar extends StatefulWidget {
  ...
  AnimatedBottomBar({
    ...
    required this.activatedIconColor,
    required this.background,
    required this.buttonsIcons,
    required this.buttonsHiddenIcons,
    required this.backgroundColorMiddleIcon,
    required this.onTapButton,
    required this.onTapButtonHidden,
  }) : assert(buttonsIcons.length == buttonsHiddenIcons.length &&
            buttonsIcons.length == 4);

  @override
  State<AnimatedBottomBar> createState() => _AnimatedBottomBar();
}
...
class _AnimatedBottomBar extends State<AnimatedBottomBar>
  ...
  void initState() {
    super.initState();
    _controllerButtonsChanging = AnimationController(
        vsync: this, duration: const Duration(milliseconds: 200));
    _controllerFloatButtonDropIn = AnimationController(
        vsync: this, duration: const Duration(milliseconds: 100));
    _controllerFloatButtonDropOut = AnimationController(
        vsync: this, duration: const Duration(milliseconds: 200));
    _controllerContainerDropIn = AnimationController(
        vsync: this, duration: const Duration(milliseconds: 100));
    _controllerContainerDropOut = AnimationController(
  ...
  Widget build(BuildContext context) {
    ...
    _animationBorder =
        Tween<double>(begin: 0.0, end: widgetScreen).animate(CurvedAnimation(
      parent: _controllerButtonsChanging!,
      curve: Curves.ease,
    ));
    ...
    _animationFloatButtonDropIn =
        Tween<double>(begin: widgetScreen / 1.8, end: 10)
    ...
    _animationFloatButtonDropOut =
        Tween<double>(begin: widgetScreen / 1.8, end: widgetScreen * 1.5)
            .animate(CurvedAnimation(
